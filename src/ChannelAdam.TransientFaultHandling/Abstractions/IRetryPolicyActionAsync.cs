//-----------------------------------------------------------------------
// <copyright file="IRetryPolicyActionAsync.cs">
//     Copyright (c) 2015-2018 Adam Craven. All rights reserved.
// </copyright>
//
...
namespace ChannelAdam.TransientFaultHandling
{
    ...
    /// </summary>
    public interface IRetryPolicyActionAsync
    {
        /// <summary>
        ...
        /// </returns>
        Task ExecuteAsync(Func<Task> taskAction);
        ...
        /// the retry limit is reached, the returned task will transition to a faulted state and the exception must be observed.
        /// </returns>
        Task ExecuteAsync(Func<Task> taskAction, CancellationToken cancellationToken);
    }
}